...
public class RNFFluids {
    ...
    public static final FluidEntry<BaseFlowingFluid.Flowing> GOOPANIUM =
            REGISTRATE.standardFluid("goopanium",
                    SolidRenderedPlaceableFluidType.create(0x32a852,
                            () -> 1f / 32f))
                    .lang("Goopanium")
